...
function Home() {
    ...
    const municipio = useContext(FiltradoContext);
        ...
        <div>
            ...
            <div className="relative">
                <div className="w-1/2 flex items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <a className="absolute right-0 bg-green-500 mr-7 text-white rounded-xl h-12 w-32 flex items-center justify-center cursor-pointer transition hover:scale-110" href="/viviendas" onClick={municipio(valor)} >
