        ...
        <section className="relative">
            ...
            <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
                <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <a href="#" className="group relative inline-flex items-center overflow-hidden rounded bg-green-500 px-8 py-3 text-white focus:outline-none active:bg-green-700">
                        ...
                        <a href="#" className="group relative inline-flex items-center overflow-hidden rounded bg-white px-8 py-3 text-white focus:outline-none active:bg-gray-200">
                            <span className="absolute -start-full transition-all group-hover:start-4">
                                <svg
                            ...
                            <span className="text-md text-green-500 font-medium transition-all group-hover:ms-4">
                                Saber más
                            </span>
                        </a>
                    </div>
