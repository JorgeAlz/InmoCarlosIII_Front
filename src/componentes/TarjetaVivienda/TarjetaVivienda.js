const TarjetaVivienda = (props) => {
    ...
    return (
        <li>
            <a href="#" className="block rounded-lg p-4 border shadow-md shadow-indigo-100 transition-all transform hover:scale-105 hover:shadow-xl hover:shadow-indigo-100">
                <img
                    alt="Home"
